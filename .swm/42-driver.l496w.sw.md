...
`WriteAheadLog` 及其基于 rolling file 的实现 `FileBasedWriteAheadLog` 我们在 \[4.1 Executor 端长时容错详解](41-executor.o65r1.sw.md) 详解过了，下面我们主要看 `ReceivedBlockTracker` 如何使用 WAL。
...
This file was generated by Swimm. [Click here to view it in the app](https://swimm-web-app.web.app/repos/Z2l0aHViJTNBJTNBQ29vbHBsYXlTcGFyayUzQSUzQWdpbGFkbmF2b3Q=/docs/l496w).